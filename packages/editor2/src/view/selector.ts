...
const haveIntersection = Konva.Util.haveIntersection;
...
export class Selector extends Konva.Rect {
  override className = 'Selector';
  ...
  onPointerMove(e: Konva.KonvaPointerEvent) {
    if (!this.selecting) {
      return;
    }
  ...
  onPointerClick(e: Konva.KonvaPointerEvent) {
